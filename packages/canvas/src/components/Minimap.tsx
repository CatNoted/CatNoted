...
export const Minimap: React.FC<MinimapProps> = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 items-end">
      <span className="text-[9px] font-mono font-semibold text-muted-foreground uppercase tracking-widest">Minimap navigation</span>
      <div
        ref={minimapRef}
        onMouseDown={handleMouseDown}
        style={{ width: minimapWidth, height: minimapHeight }}
        className="bg-card/70 border border-border/80 rounded-2xl relative overflow-hidden shadow-lg shadow-sm dark:shadow-none cursor-crosshair select-none backdrop-blur-md"
      >
        ...
        {elementList.map(el => {
          ...
          return (
            <div
              ...
              className="absolute bg-primary/20 dark:bg-primary/20 border border-primary/30 dark:border-primary/30 rounded-sm"
            />
          );
        })}
