...
export const InfiniteCanvas: React.FC = () => {
  ...
  return (
    <div
      ...
      className="h-[75vh] w-full border border-border rounded-3xl overflow-hidden bg-muted/30 shadow-inner relative cursor-grab active:cursor-grabbing select-none"
    >
      ...
      <div className="absolute bottom-6 left-6 z-40 bg-background/80 backdrop-blur-md border border-border/60 rounded-2xl px-3 py-2 flex items-center gap-2 shadow-lg shadow-black/5">
        <button
          onClick={() => setSnapToGrid(prev => !prev)}
          className={`px-2 py-0.5 rounded-lg transition-colors text-[10px] font-mono font-semibold ${snapToGrid ? 'bg-primary/20 text-primary dark:bg-primary/80 dark:text-primary-foreground' : 'text-muted-foreground hover:text-foreground hover:bg-secondary'}`}
        ...
        <button
          ...
          className="p-1 hover:bg-secondary rounded-lg text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors"
          title="Zoom Out"
          aria-label="Zoom Out"
          type="button"
        >
        ...
        <button
          ...
          className="px-2 py-0.5 hover:bg-secondary rounded-lg text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors text-[10px] font-mono font-semibold"
      ...
      {isHelpActive && (
        <div className="absolute top-6 left-6 z-50 max-w-sm bg-card/95 backdrop-blur-md border border-border/80 rounded-2xl p-5 shadow-2xl animate-in fade-in slide-in-from-left-4 duration-200 select-text">
          ...
          <div className="flex flex-col gap-3.5 overflow-y-auto max-h-[50vh] text-xs">
            {/* Controls */}
            <div>
              <h4 className="font-semibold text-foreground/80 mb-1.5 uppercase tracking-wider text-[10px]">Controls & Actions</h4>
              <ul className="space-y-1 text-muted-foreground">
                <li className="flex justify-between items-center gap-2">
                  <span>Pan Canvas</span>
                  <span className="font-medium text-muted-foreground">Drag Background</span>
                </li>
                <li className="flex justify-between items-center gap-2">
                  <span>Zoom Canvas</span>
                  <span className="font-medium text-muted-foreground">Scroll Wheel</span>
                </li>
                <li className="flex justify-between items-center gap-2">
                  <span>Marquee Select</span>
                  <span className="font-medium text-muted-foreground">Shift + Drag Background</span>
                </li>
                <li className="flex justify-between items-center gap-2">
                  <span>Draw Connector</span>
                  <span className="font-medium text-muted-foreground">Drag right card dot</span>
                </li>
                <li className="flex justify-between items-center gap-2">
                  <span>Lock Element</span>
                  <span className="font-medium text-muted-foreground">Ctrl + L</span>
                </li>
                <li className="flex justify-between items-center gap-2">
            ...
            {/* Creation Shortcuts */}
            <div>
              <h4 className="font-semibold text-foreground/80 mb-1.5 uppercase tracking-wider text-[10px]">Toolbar Shortcuts</h4>
              <div className="grid grid-cols-2 gap-2 text-muted-foreground">
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">C</kbd>
                  <span>Add Card</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">R</kbd>
                  <span>Add Rectangle</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">E / O</kbd>
                  <span>Add Ellipse</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">T</kbd>
                  <span>Add Text Note</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">F</kbd>
                  <span>Add Frame</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <kbd className="px-1.5 py-0.5 bg-muted border border-border rounded text-[10px] font-mono font-bold">Shift + G</kbd>
                  <span>Grid Snap</span>
                </div>
              </div>
            </div>
      ...
      {/* Undo Toast Banner */}
      {undoToast && (
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-50 bg-primary/95 text-primary-foreground border border-border dark:border-border rounded-2xl px-4 py-3 flex items-center gap-4 shadow-2xl animate-in slide-in-from-top-4 duration-300 max-w-sm">
