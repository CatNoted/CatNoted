          ...
          >
            ...
            <div className={`w-12 flex-shrink-0 flex items-start justify-end gap-1 px-1 opacity-0 group-hover:opacity-100 transition-opacity ${
              ...
              <button
                ...
                className="p-1 hover:bg-accent rounded text-foreground/50 hover:text-primary transition-colors"
              >
                ...
                {activeMenuId === block.id && (
                  <div className="absolute left-0 mt-1 w-40 bg-card border border-border rounded-xl shadow-lg z-50 py-1 text-xs">
                    <button
                      ...
                      className="w-full px-3 py-2 text-left flex items-center gap-2 hover:bg-accent text-foreground"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 text-left flex items-center gap-2 hover:bg-accent text-primary"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 text-left flex items-center gap-2 hover:bg-accent text-red-500"
                    >
