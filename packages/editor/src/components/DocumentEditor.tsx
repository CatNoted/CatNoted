    ...
    <div className="max-w-3xl mx-auto py-10 space-y-0.5">
      {blocks.map((block, index) => {
        ...
        return (
          <div 
            key={block.id} 
            className="group flex items-start gap-0 px-4 py-0.5 rounded-lg transition-all hover:bg-slate-50 dark:hover:bg-zinc-900/50"
          >
            ...
            <div className="w-14 flex-shrink-0 flex items-start justify-end gap-0.5 pt-[3px] opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="p-1 hover:bg-slate-200 dark:hover:bg-zinc-700 rounded text-slate-400 hover:text-slate-700 dark:hover:text-zinc-200"
              >
