                    ...
                    >
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-full bg-transparent font-semibold text-foreground outline-none focus-visible:ring-1 focus-visible:ring-border rounded px-0.5 placeholder:text-muted-foreground"
                        />
                      </div>
                      ...
                      {row.map((cell, cIdx) => (
                        ...
                        >
                          <input
                            ...
                            className="w-full bg-transparent text-foreground outline-none focus-visible:ring-1 focus-visible:ring-border rounded px-0.5 placeholder:text-muted-foreground transition-colors"
                          />
                        </td>
                      ))}
                    </tr>
