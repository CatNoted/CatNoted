...
export const KanbanBlock: React.FC<KanbanBlockProps> = ({
  ...
  return (
    <div className="w-full my-6 p-4 rounded-2xl border border-border bg-muted/20 bg-card/30 shadow-sm select-none">
      {/* Board Header */}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 mb-3 group/col-header">
                <span className="cursor-grab active:cursor-grabbing p-0.5 rounded text-muted-foreground hover:bg-muted transition-colors">
                    ...
                    >
                      <div className="flex items-start gap-1.5">
                        ...
                        <textarea
                          ...
                          className="w-full resize-none text-[11px] leading-relaxed bg-transparent text-foreground border-none outline-none focus-visible:ring-1 focus-visible:ring-border rounded p-0.5 placeholder:text-muted-foreground focus-visible:bg-muted transition-all"
                          style={{ height: 'auto' }}
                          onInput={(e) => {
              ...
              <button
                ...
                className="mt-2 w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-lg transition-colors border border-transparent hover:border-border"
              >
                <Plus className="w-3.5 h-3.5" />
                <span>Add Card</span>
              </button>
