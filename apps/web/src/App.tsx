    ...
    const titleField = isEditingTitle ? (
      ...
      <div className="flex items-center gap-1.5 group/title min-w-0">
        <span
          ...
          className="text-xs font-semibold text-foreground flex-1 min-w-0 truncate cursor-pointer hover:bg-secondary/60 px-1.5 py-0.5 rounded transition-colors"
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-border p-0.5 opacity-0 group-hover/title:opacity-100 focus-visible:opacity-100"
    ...
    const actions = (
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        >
          ...
          <span className="max-w-[100px] flex-1 min-w-0 truncate text-[10px] font-semibold hidden sm:inline">{userEmail}</span>
        </button>
      </div>
    );
