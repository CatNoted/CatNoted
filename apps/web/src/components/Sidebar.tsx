    ...
    <div className="w-64 border-r border-soft bg-surface h-full flex flex-col shrink-0 text-ink select-none">
      <div className="px-4 pt-4 pb-2">
        <div className="flex items-center gap-2.5 px-1.5 py-1">
          ...
          <span className="font-semibold text-[14px] text-ink tracking-tight truncate min-w-[120px]" title="CatNoted Workspace">
            CatNoted Workspace
          </span>
        </div>
      </div>
      ...
      <div className="px-3 py-1.5 space-y-0.5">
        <button
          ...
          className={`${itemClassName} ${activeMode === 'doc' ? 'bg-surface-hover text-accent font-semibold' : ''}`}
        >
        ...
        <button
          ...
          className={`${itemClassName} ${activeMode === 'canvas' ? 'bg-surface-hover text-accent font-semibold' : ''}`}
        >
        ...
        <button
          ...
          className={`${itemClassName} ${activeMode === 'graph' ? 'bg-surface-hover text-accent font-semibold' : ''}`}
        >
        ...
        <button
          ...
          className={`${itemClassName} ${activeMode === 'journals' ? 'bg-surface-hover text-accent font-semibold' : ''}`}
        >
        ...
        <button
          ...
          className={`${itemClassName} ${activeMode === 'settings' ? 'bg-surface-hover text-accent font-semibold' : ''}`}
        >
