...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-overlay/40 dark:bg-overlay/60 backdrop-blur-[2px] z-[100] flex items-center justify-center p-4">
      <div className="bg-surface dark:bg-surface border border-soft/80 rounded-2xl w-full max-w-[760px] h-[580px] shadow-2xl relative flex flex-col md:flex-row overflow-hidden">
