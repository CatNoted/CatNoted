...
def verify():
    with sync_playwright() as p:
        ...
        page.screenshot(path="/home/jules/verification/screenshots/streaming.png")

        # Wait for the widget to appear (or the final response)
